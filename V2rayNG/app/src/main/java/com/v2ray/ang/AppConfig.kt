...
object AppConfig {
    ...
    /** Zentra: режим раздельного туннелирования сайтов. */
    const val PREF_ZENTRA_SPLIT_MODE = "pref_zentra_split_mode"
    const val ZENTRA_SPLIT_MODE_FULL = "full"
    const val ZENTRA_SPLIT_MODE_RU_DIRECT = "ru_direct"
    ...
    const val DELAY_TEST_URL2 = "https://www.cloudflare.com/cdn-cgi/trace"
    ...
    const val DNS_PROXY_DOH = "https://cloudflare-dns.com/dns-query"

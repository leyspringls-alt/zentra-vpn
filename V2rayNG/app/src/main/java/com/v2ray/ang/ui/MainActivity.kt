...
class MainActivity : HelperBaseActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    private fun applyRunningState(isLoading: Boolean, isRunning: Boolean) {
        ...
        if (isRunning) {
            ...
            binding.tvZentraStatus.text = getString(R.string.zentra_status_connected)
            binding.tvZentraHint.text = getString(R.string.zentra_hint_connected)
            ...
            binding.tvZentraStatus.text = getString(R.string.zentra_status_disconnected)
            binding.tvZentraHint.text = getString(R.string.zentra_hint_disconnected)
